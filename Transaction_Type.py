...
Credits_Refund_Yellow = ['Refund','Refund','Refund','Refund','Refund','Refund','Refund','Refund','Refund','Cash Payment','Wire Payment','ACH Payment','ACH Payment','Paper Check','e-Check','Online Transfer','ATM Payment','Reversal','Award']
Credits_Refund_Green = ['Refund','Refund','Cash Payment','Wire Payment','ACH Payment','ACH Payment','Paper Check','e-Check','Online Transfer','ATM Payment','Reversal','Award']
